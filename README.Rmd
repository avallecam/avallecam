...
- ⚙️ I use `R` daily
- 😎 I invite you to take a look to my coding **cheatsheet** in [gist](https://gist.github.com/avallecam)
- 🌍 I actively share **solutions** for the community in [stackoverflow](https://stackoverflow.com/users/6702544/avallecam)
