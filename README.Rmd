...
🏗️ 
I take **data** problems to learn new **tools** in the route to solve them, **motivated** by causal questions and **reproducible** workflows.
<!-- create -->
...
🔓 Practicing **open** research from its **design**, learning how to **teach** better, and promote **healthy** work environments!
...
- ⭐ Coordinator in a last [outbreak analysis course](https://www.cursoepidemias-col-peru-2021.org/) in [latinamerica](https://twitter.com/avallecam/status/1413682203041701889?s=20);
...
- 📚 I have my list of academic **publications** in ![](https://orcid.org/sites/default/files/images/orcid_16x16.png) [orcid](https://orcid.org/0000-0002-7779-481X) and [scholar](https://scholar.google.com/citations?user=p1Tq4esAAAAJ&hl=es);
...
- ⚙️ I am a fluent **`R`** programmer, proficient data **wrangler**, and **visualization** enthusiast, familiar with spatio-temporal analysis;
...
- 🥤 I have been **trained** by awesome communities like: [ictp-saifr](https://www.ictp-saifr.org/v-southern-summer-school-on-mathematical-biology/), [codata-rda](https://www.datascienceschools.org/), [recon](https://www.reconlearn.org/), [metadocencia](https://www.metadocencia.org/cursos/);
...
- 🗃️ I store [memories](https://www.youtube.com/channel/UCvbhEkxtIVA9ldfhqDFALTA/playlists) in a couple more;
