...
### `r emo::ji("peru")` **Andree Valle-Campos** (pronouns: él/he/his)
...
🔓 Also interested in reproducible **open** research from its _design_, healthy **work** environments, and how to **teach** better!

⛑️ This is my **cv**. Here my [resume](https://github.com/avallecam/resume/raw/main/cv-andree_vallecampos.pdf).
...
- ♻️ shinyapps: https://avallecam.shinyapps.io/data_qc/ translated to [[ES](https://avallecam.shinyapps.io/data_qc-es/)]
