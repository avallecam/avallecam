...
- ⚙️ I am a fluent **`R`** programmer, proficient data **wrangler** and **visualization** enthusiast. 
- 📀 I have made analysis **workflows** with **omic**, serological, gps, health service and **spatio-temporal** data;
