...
- 📜 I did my [BSc](https://github.com/avallecam/abnomic) research about antibody responses against severe vivax malaria using protein microarrays (**UNMSM, 2015**);

### MORE

- ⚙️ I am a fluent **`R`** programmer, proficient data **wrangler**, and **visualization** creator, familiar with spatio-temporal analysis;
