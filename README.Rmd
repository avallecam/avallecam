...
🏗️ 
I take **data** problems to learn new **tools** in the route to solve them, **motivated** by causal questions and **create** reusable software.
<!-- discussing their interpretation and implications. -->
<!-- satisfy my **own** expectations, and **motivate** myself :) -->

🔓 Practicing reproducible **open** research from its **design**, learning how to **teach** better, and promote **healthy** work environments!
...
⛑️ This site contains **links** to all my scientific **contributions**. Here is a structured **pdf** version of my [cv/resume](https://github.com/avallecam/resume/raw/main/cv-andree_vallecampos.pdf).
...
- ⭐ Coordinator in a last [outbreak analysis course](https://www.cursoepidemias-col-peru-2021.org/) in latinamerica ([thread](https://twitter.com/avallecam/status/1413682203041701889?s=20));
...
- 📜 I did my [BSc](https://github.com/avallecam/abnomic) research about antibody response against severe malaria using protein microarrays (**UNMSM, 2015**);

### MORE

- ⚙️ I am a fluent **`R`** programmer, with experience in spatio-temporal analysis;
...
- 💌 I love to collect **links** for a lot of topics in a public [trello board](https://trello.com/b/xtO9VP36/scibites);
- 💬 Ping me about **applied biostatistics**, **data science education**, and **reproducible research**;
...
- 💾 [ES] data exploration: https://avallecam.shinyapps.io/data_qc-es/
...
- 🔖 link: https://ojo-publico.com/1718/datos-y-transparencia-para-luchar-contra-el-coronavirus

📌 __[editorial][ES] Health Data Science: Applications at CDC Perú, 2019__

- 🔖 link: https://avallecam.github.io/health_data_science_editorial/20191208-cdc_editorial.html
...
🔔 __[poster][ES] Epidemiological analysis of the epidemic of Guillain Barré Syndrome in Peru, 2019__
...
🔔 __[poster] Human mobility and malaria history in a periurban community of the Peruvian Amazon, 2019__
...
📌 __[ES] Data analysis in epidemiological surveillance I: time, space, person and epidemic curve, 2021__
...
📌 __[ES] Gene regulatory networks, 2015-2017__
...
- 🌠 I have a wishlist in [elfster](https://www.elfster.com/profile/097d261f-1196-45a1-a4b4-12e0b245ce2d/wish-lists/be4efeaf-b9e7-465d-bcac-65ef129be519/);
- 🖤 I am reading a manga called [berserk](https://readberserk.com/chapter/berserk-chapter-a0/);
...
- 🥦 I got curious about physical biology after: [goodwin](https://libgen.rs/book/index.php?md5=CBFF641AD61645A284EE4566EB2B0146), [bejan](https://libgen.rs/book/index.php?md5=F9D8AF5DCDF3C74ED2C34A56C7522E22), [cabrera](https://www.researchgate.net/publication/313988377_ON_NATURAL_STRUCTURES_THE_UNIFICATION_OF_NATURE)-[febola](https://www.researchgate.net/publication/313988382_ON_NATURAL_STRUCTURES_COMPLEMENTARY_ISSUES);
...
- 🎲 I frequently listen [radiohead](https://youtu.be/I4pezRt9boY), [apparat](https://youtu.be/NOol5V4Tlk8), [niños sin](https://youtu.be/S5vKPHigWqY) [smartphones](https://youtu.be/QI9mksVqivg);
...
- 💕 I intentionally used **cam** in reference to my [chinese](https://www.mychinaroots.com/surnames/detail?word=Campos) ancestry
