...
🏗️ 
I take **data** problems to learn new **tools** in the route to solve them, **motivated** by causal questions and **discussing** their interpretations.
...
- 🚧 [incidenceflow](https://github.com/avallecam/incidenceflow) - tidy incidence workflow.
...
- 💚 [epitidy](https://github.com/avallecam/epitidy) - tidy tables and model outputs.
